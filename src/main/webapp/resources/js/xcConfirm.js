...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		if("info" == type)
			var $ok = $("<a href='javascript:void(0);'>").addClass("sgBtn").addClass("ok").text("取消");//确定按钮
		else
			var $ok = $("<a href='javascript:rechargeOk();'>").addClass("sgBtn").addClass("ok").text("成功");//确定按钮
		var $cancel = $("<a href='javascript:void(0);'>").addClass("sgBtn").addClass("cancel").text("重试");//取消按钮
